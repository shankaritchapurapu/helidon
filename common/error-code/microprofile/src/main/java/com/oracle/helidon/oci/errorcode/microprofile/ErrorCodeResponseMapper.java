...
/**
 * Maps a Response to a {@link com.oracle.helidon.oci.errorcode.RenderableException} for MicroProfile Rest Client.
 */
public class ErrorCodeResponseMapper implements ResponseExceptionMapper<RenderableException> {
    ...
    public RenderableException toThrowable(Response response) {
        ...
        return new RenderableException(errorDetail.getErrorCode(),
