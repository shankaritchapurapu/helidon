...
/**
 * Agent control plane metering configuration mapped from {@code oci.metering}.
 * <p>
...
interface AgentMeteringConfigBlueprint {
    /**
    ...
    /**
     * Maximum workers for the full control plane agent path.
     *
     * @return max workers
     */
    @Option.Configured
    ...
    /**
     * Bucket configurations for the full control plane agent path.
     *
    ...
    /**
     * Maximum archive workers for the full control plane agent path.
     *
    ...
    /**
     * Scan page size for the full control plane agent path.
     *
    ...
    /**
     * Maximum writes per transaction for the full control plane agent path.
     *
