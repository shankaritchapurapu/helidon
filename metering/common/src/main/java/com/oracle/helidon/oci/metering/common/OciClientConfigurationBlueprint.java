...
interface OciClientConfigurationBlueprint extends Prototype.Factory<ClientConfiguration> {
     ...
     */
    @Option.Configured
    Optional<RetryConfiguration> retryConfiguration();

    /**
     * Circuit breaker behavior for OCI SDK requests.
     *
     * @return optional circuit breaker configuration
     */
    @Option.Configured
    Optional<CircuitBreakerConfiguration> circuitBreakerConfiguration();
}
