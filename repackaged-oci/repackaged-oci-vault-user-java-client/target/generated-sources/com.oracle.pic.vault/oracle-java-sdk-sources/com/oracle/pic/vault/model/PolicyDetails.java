...
public final class PolicyDetails  {
    ...
    public PolicyDetails(String requestId, String leaseId, Boolean renewable, Integer leaseDuration, PolicyData data) {
        super();
    ...
    public static class Builder {
        ...
        public Builder data(PolicyData data) {
            this.data = data;
            return this;
        }
        ...
        public PolicyDetails build() {
            PolicyDetails model = new PolicyDetails(this.requestId
                , this.leaseId
                , this.renewable
                , this.leaseDuration
