...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RoleDetails.Builder.class)

public final class RoleDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"requestId", "leaseId", "renewable", "leaseDuration", "data"})
    public RoleDetails(String requestId, String leaseId, Boolean renewable, Integer leaseDuration, RoleData data) {
        super();
    ...
    public static class Builder {
        ...
        public Builder data(RoleData data) {
            this.data = data;
            return this;
        }
        ...
        public RoleDetails build() {
            RoleDetails model = new RoleDetails(this.requestId
                , this.leaseId
                , this.renewable
                , this.leaseDuration
        ...
        public Builder copy(RoleDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        RoleDetails other = (RoleDetails) o;
