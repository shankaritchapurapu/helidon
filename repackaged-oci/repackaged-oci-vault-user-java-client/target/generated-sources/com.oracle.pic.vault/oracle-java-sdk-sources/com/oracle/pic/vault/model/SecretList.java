...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SecretList.Builder.class)

public final class SecretList  {
    @Deprecated
    @java.beans.ConstructorProperties({"keys"})
    public SecretList(java.util.List<String> keys) {
        super();
        this.keys = keys;
    }
    ...
    public static class Builder {
        ...
        public SecretList build() {
            SecretList model = new SecretList(this.keys);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecretList model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretList)) {
            return false;
        }

        SecretList other = (SecretList) o;
