...
public final class ConfigDetails  {
    ...
    public ConfigDetails(String requestId, String leaseId, Boolean renewable, Integer leaseDuration, ConfigData data) {
        super();
    ...
    public static class Builder {
        ...
        public Builder data(ConfigData data) {
            this.data = data;
            return this;
        }
        ...
        public ConfigDetails build() {
            ConfigDetails model = new ConfigDetails(this.requestId
                , this.leaseId
                , this.renewable
                , this.leaseDuration
