...
public class UpdateConfigRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.pic.vault.model.UpdateConfigDetails> {
...
* 
    ...
    private com.oracle.pic.vault.model.UpdateConfigDetails updateConfigDetails;

    

    
    public com.oracle.pic.vault.model.UpdateConfigDetails getUpdateConfigDetails() {
    ...
    public com.oracle.pic.vault.model.UpdateConfigDetails getBody$() {
        return updateConfigDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateConfigRequest, com.oracle.pic.vault.model.UpdateConfigDetails> {
...
* 
        ...
        private com.oracle.pic.vault.model.UpdateConfigDetails updateConfigDetails = null;
         ...
         * @return this builder instance
         */
        public Builder updateConfigDetails(com.oracle.pic.vault.model.UpdateConfigDetails updateConfigDetails) {
        ...
        public Builder copy(UpdateConfigRequest o) {
            xVaultToken(o.getXVaultToken());authPluginName(o.getAuthPluginName());configName(o.getConfigName());ifMatch(o.getIfMatch());updateConfigDetails(o.getUpdateConfigDetails());
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.pic.vault.model.UpdateConfigDetails body) {
        ...
        public UpdateConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateConfigRequest(xVaultToken, authPluginName, configName, ifMatch, updateConfigDetails);
        }
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateConfigDetails == null ? 43 : this.updateConfigDetails.hashCode());
        return result;
    }
}