...
public class GetRoleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetRoleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.pic.vault.model.RoleDetails roleDetails) {
        super(__httpStatusCode__, headers);
        this.roleDetails = roleDetails;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetRoleResponse> {
         ...
         */
        @Override
        public Builder copy(GetRoleResponse o) {
        ...
        public GetRoleResponse build() {
            return new GetRoleResponse(__httpStatusCode__, headers, roleDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRoleResponse)) {
            return false;
        }

        GetRoleResponse other = (GetRoleResponse) o;
