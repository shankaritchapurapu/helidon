...
public class GetConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetConfigResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.pic.vault.model.ConfigDetails configDetails) {
        super(__httpStatusCode__, headers);
        this.configDetails = configDetails;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetConfigResponse> {
        ...
        public GetConfigResponse build() {
            return new GetConfigResponse(__httpStatusCode__, headers, configDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        GetConfigResponse other = (GetConfigResponse) o;
