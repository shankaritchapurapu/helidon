...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ListDetails.Builder.class)

public final class ListDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"requestId", "leaseId", "renewable", "leaseDuration", "data"})
    public ListDetails(String requestId, String leaseId, Boolean renewable, Integer leaseDuration, ListData data) {
        super();
    ...
    public static class Builder {
        ...
        public ListDetails build() {
            ListDetails model = new ListDetails(this.requestId
                , this.leaseId
                , this.renewable
                , this.leaseDuration
        ...
        public Builder copy(ListDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        ListDetails other = (ListDetails) o;
