...
public class LoginUsingPkiResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private LoginUsingPkiResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.pic.vault.model.LoginResponse loginResponse) {
        super(__httpStatusCode__, headers);
        this.loginResponse = loginResponse;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<LoginUsingPkiResponse> {
         ...
         */
        @Override
        public Builder copy(LoginUsingPkiResponse o) {
         ...
         */
        @Override
        public LoginUsingPkiResponse build() {
            return new LoginUsingPkiResponse(__httpStatusCode__, headers, loginResponse);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoginUsingPkiResponse)) {
            return false;
        }

        LoginUsingPkiResponse other = (LoginUsingPkiResponse) o;
