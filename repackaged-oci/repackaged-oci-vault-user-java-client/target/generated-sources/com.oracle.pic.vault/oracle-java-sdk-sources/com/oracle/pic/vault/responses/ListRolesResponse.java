...
public class ListRolesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListRolesResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.pic.vault.model.ListDetails listDetails) {
        super(__httpStatusCode__, headers);
        this.listDetails = listDetails;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListRolesResponse> {
        ...
        public ListRolesResponse build() {
            return new ListRolesResponse(__httpStatusCode__, headers, listDetails);
        }
    }
