...
public class ListRolesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListRolesRequest, java.lang.Void> {
     ...
     */
        ...
        public ListRolesRequest buildWithoutInvocationCallback() {
            ...
            request.list = list;
            return request;
            // new ListRolesRequest(xVaultToken, authPluginName, list);
        }
    }
