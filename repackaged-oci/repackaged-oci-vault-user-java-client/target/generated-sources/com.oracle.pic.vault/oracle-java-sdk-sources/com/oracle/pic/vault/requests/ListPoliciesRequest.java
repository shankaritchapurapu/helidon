...
public class ListPoliciesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListPoliciesRequest, java.lang.Void> {
     ...
     */
        ...
        public Builder copy(ListPoliciesRequest o) {
            xVaultToken(o.getXVaultToken());list(o.getList());
        ...
        public ListPoliciesRequest buildWithoutInvocationCallback() {
            ...
            request.list = list;
            return request;
            // new ListPoliciesRequest(xVaultToken, list);
        }
    }
