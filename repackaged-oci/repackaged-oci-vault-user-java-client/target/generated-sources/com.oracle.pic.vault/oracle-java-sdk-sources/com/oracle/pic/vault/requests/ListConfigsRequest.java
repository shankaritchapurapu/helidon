...
public class ListConfigsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListConfigsRequest, java.lang.Void> {
     ...
     */
        ...
        public Builder copy(ListConfigsRequest o) {
            xVaultToken(o.getXVaultToken());authPluginName(o.getAuthPluginName());list(o.getList());
        ...
        public ListConfigsRequest buildWithoutInvocationCallback() {
            ...
            request.list = list;
            return request;
            // new ListConfigsRequest(xVaultToken, authPluginName, list);
        }
    }
