...
public class UpdateConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateConfigResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.pic.vault.model.ConfigDetails configDetails) {
        super(__httpStatusCode__, headers);
        this.configDetails = configDetails;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateConfigResponse> {
        ...
        public UpdateConfigResponse build() {
            return new UpdateConfigResponse(__httpStatusCode__, headers, configDetails);
        }
    }
