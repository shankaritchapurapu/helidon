package io.helidon.integrations.oci.swagger.codegen.helidon;
...
public class OracleJavaHelidonServiceCodegenOperation extends OracleJavaCodegenOperation {
    ...
    private void resolveContexts(OracleJavaHelidonServiceCodegen oracleJavaHelidonServiceCodegen) {
        if (oracleJavaHelidonServiceCodegen.getOptionValue(ConfigOption.OPTION_CONTEXTS_IDENTITY)) {
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_JAXRS_HTTPHEADERS)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
                            + ".ws.rs.core.Context "
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_JAXRS_URIINFO)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
                            + ".ws.rs.core.Context "
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_JAXRS_REQUEST)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
                            + ".ws.rs.core.Context "
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_JAXRS_SECURITYCONTEXT)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
                            + ".ws.rs.core.Context "
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_AUTHPROXY_IDENTITY)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_AUDIT_PAYLOAD_APPENDER)) {
            contextsToInclude.add(
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_CONTAINER_REQUEST)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
                            + ".ws.rs.core.Context "
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_CONTEXTS_CONTAINER_RESPONSE)) {
            contextsToInclude.add(
                    "@"
                            + annotationPackage
                            + ".ws.rs.core.Context "
    ...
    private void resolveReturnType(
        ...
        if (oracleJavaHelidonServiceCodegen.getOptionValue(
                ConfigOption.OPTION_USE_JAXRS_SERVICE_RESPONSE)) {
