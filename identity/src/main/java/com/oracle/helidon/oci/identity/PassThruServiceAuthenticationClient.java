...
import com.oracle.pic.identity.authentication.requests.AuthenticateRequest;
import com.oracle.pic.identity.authentication.responses.AuthenticateResponse;
...
class PassThruServiceAuthenticationClient implements ServiceAuthenticationClient {
    ...
    private static final String DUMMY_OCID =
            "ocid1.tenancy.oc1.."
    ...
    @Override
    public DynamicSslContextProviderConfig getDynamicSslContextProviderConfig() {
        DynamicSslContextProviderConfig dummyConfig = new DynamicSslContextProviderConfig();
        return dummyConfig;
    }
