 ...
 * <p>
 * There is a mapper module  for Helidon WebServer (with error handler).
 * It is sufficient to add this module to your classpath, mappers are discovered through service loader.
 */
