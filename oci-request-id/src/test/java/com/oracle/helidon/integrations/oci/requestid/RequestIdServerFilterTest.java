...
import static com.oracle.helidon.integrations.oci.requestid.OciHeaderNames.OPC_REQUEST_ID;
...
class RequestIdServerFilterTest {
    ...
    void testRequestFilter() {
        ...
        assertThat(map.containsKey(OPC_REQUEST_ID), is(true));
    }
    ...
    void testResponseFilter() {
        ...
        assertThat(requestMap.getFirst(OPC_REQUEST_ID), is(responseMap.getFirst(OPC_REQUEST_ID)));
    }
    ...
    void testLoggingMdc() {
        ...
        RequestIdServerFilter filter = new RequestIdServerFilter();
        filter.filter(requestContext);
        assertThat(JulMdc.get(OPC_REQUEST_ID), notNullValue());
    }
