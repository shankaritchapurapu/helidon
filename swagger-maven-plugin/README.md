...
The generated service stubs currently result in an abstract classes you can extend from.  It is recommend you extend from 'Abstract<yourservice>BaseResource'.  This is the latest version that allows you the most ability to customize the injected contexts.
