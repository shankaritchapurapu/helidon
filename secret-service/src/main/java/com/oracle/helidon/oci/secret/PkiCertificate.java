...
/**
 * Represents the certificate from PKI service as well as the chain of the downloaded certificate.
 */
public class PkiCertificate {
    ...
    /**
     * Create an instance of PkiCertificate.
     *
     * @param jsonBlob certificate data
