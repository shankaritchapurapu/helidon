# Helidon Talon Documentation

Helidon Talon is a collection of Helidon extensions for OCI-native services and OCI-specific platform
...
Helidon Talon modules register framework-provided `Supplier<?>` and
...
The lower weight lets applications override a Helidon Talon default by registering the same
