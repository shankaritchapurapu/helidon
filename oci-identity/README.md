...
| oci-identity.memoryThreshold     | 4 K                  | The in-memory buffer size. Anything after this value will be streamed to offline file storage.                         | [RepeatableInputStreamer](src/main/java/com/oracle/helidon/oci/identity/RepeatableInputStreamer.java)               |
