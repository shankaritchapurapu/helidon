 ...
 */
package io.helidon.oci.tests.error.code.jsonb;
...
/**
 * This test validates that {@link com.oracle.helidon.oci.errorcode.ErrorDetail}
...
public class JsonbErrorCodeTest {
    ...
    @Path("/")
    @RegisterProvider(com.oracle.helidon.oci.errorcode.microprofile.ErrorCodeResponseMapper.class)
