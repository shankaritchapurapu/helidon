...
The Swagger (OpenAPI) generation can be configured by using the `helidon-oci-swagger-maven-plugin`. For detailed usage information about this plug-in, please see the [README](../../oci-swagger-maven-plugin/README.md)
